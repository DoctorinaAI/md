...
/// Syntax grammar for `markdown`.
///
/// Import this library only when you need `markdown` highlighting; unused
/// languages are dropped from the build.
abstract final class HighlightMarkdown {
  /// The grammar for `markdown`.
...
final Grammar _g0 = Grammar([
  ...
  GrammarToken(
      ...
      inside: () => _g1),
  GrammarToken(
      "blockquote", compileHighlightPattern("^>(?:[\\t ]*>)*", multiLine: true),
      alias: "punctuation"),
  GrammarToken(
      "table",
      compileHighlightPattern(
  ...
  GrammarToken(
      ...
      alias: "keyword"),
  GrammarToken(
      "code", compileHighlightPattern("^```[\\s\\S]*?^```\$", multiLine: true),
  ...
  GrammarToken(
      ...
      alias: "important",
      inside: () => _g7),
  GrammarToken("title", compileHighlightPattern("(^\\s*)#.+", multiLine: true),
      lookbehind: true, alias: "important", inside: () => _g8),
  GrammarToken(
      "hr",
      compileHighlightPattern("(^\\s*)([*-])(?:[\\t ]*\\2){2,}(?=\\s*\$)",
          multiLine: true),
      lookbehind: true,
      alias: "punctuation"),
  GrammarToken(
      "list",
      compileHighlightPattern("(^\\s*)(?:[*+-]|\\d+\\.)(?=[\\t ].)",
          multiLine: true),
      lookbehind: true,
      alias: "punctuation"),
  GrammarToken(
...
final Grammar _g1 = Grammar([
  ...
  GrammarToken("front-matter", compileHighlightPattern("\\S+(?:\\s+\\S+)*"),
      alias: "yaml", inside: () => HighlightYaml.grammar),
]);
...
final Grammar _g4 = Grammar([
  GrammarToken("punctuation", compileHighlightPattern("\\||:?-{3,}:?")),
]);
...
final Grammar _g6 = Grammar([
  GrammarToken(
      ...
      compileHighlightPattern(
          ...
          multiLine: true),
      lookbehind: true),
  GrammarToken("code-language", compileHighlightPattern("^(```).+"),
      lookbehind: true),
  GrammarToken("punctuation", compileHighlightPattern("```")),
]);
...
final Grammar _g10 = Grammar([
  GrammarToken("content", compileHighlightPattern("(^..)[\\s\\S]+(?=..\$)"),
      lookbehind: true, inside: () => _g11),
  GrammarToken("punctuation", compileHighlightPattern("\\*\\*|__")),
]);
...
final Grammar _g12 = Grammar([
  ...
  GrammarToken("content", compileHighlightPattern("(^\\[)[^\\]]+(?=\\])"),
      lookbehind: true, inside: () => _g13),
  GrammarToken(
      "variable", compileHighlightPattern("(^\\][ \\t]?\\[)[^\\]]+(?=\\]\$)"),
      lookbehind: true),
  GrammarToken("url", compileHighlightPattern("(^\\]\\()[^\\s)]+"),
      lookbehind: true),
  GrammarToken("string",
      compileHighlightPattern("(^[ \\t]+)\"(?:\\\\.|[^\"\\\\])*\"(?=\\)\$)"),
      lookbehind: true),
...
final Grammar _g14 = Grammar([
  GrammarToken("content", compileHighlightPattern("(^.)[\\s\\S]+(?=.\$)"),
      lookbehind: true, inside: () => _g15),
  GrammarToken("punctuation", compileHighlightPattern("[*_]")),
]);
...
final Grammar _g16 = Grammar([
  GrammarToken("content", compileHighlightPattern("(^~~?)[\\s\\S]+(?=\\1\$)"),
      lookbehind: true, inside: () => _g17),
  GrammarToken("punctuation", compileHighlightPattern("~~?")),
]);
...
final Grammar _g30 = Grammar([
  GrammarToken(
      ...
      lookbehind: true, alias: "language-regex", inside: () => _g31),
...
final Grammar _g38 = Grammar([
  GrammarToken("attr-name", compileHighlightPattern("^[^\\s=]+")),
  GrammarToken("attr-value", compileHighlightPattern("=[\\s\\S]+"),
      inside: () => _g39),
]);

final Grammar _g39 = Grammar([
  GrammarToken("value",
      compileHighlightPattern("(^=\\s*([\"']|(?![\"'])))\\S[\\s\\S]*(?=\\2\$)"),
      lookbehind: true, alias: "css", inside: () => _g21),
  GrammarToken("punctuation", compileHighlightPattern("^="),
      alias: "attr-equals"),
  GrammarToken("punctuation", compileHighlightPattern("\"|'")),
]);

final Grammar _g40 = Grammar([
  GrammarToken("attr-name", compileHighlightPattern("^[^\\s=]+")),
  GrammarToken("attr-value", compileHighlightPattern("=[\\s\\S]+"),
      inside: () => _g41),
]);

final Grammar _g41 = Grammar([
  GrammarToken("value",
      compileHighlightPattern("(^=\\s*([\"']|(?![\"'])))\\S[\\s\\S]*(?=\\2\$)"),
      lookbehind: true, alias: "javascript", inside: () => _g26),
  GrammarToken("punctuation", compileHighlightPattern("^="),
      alias: "attr-equals"),
  GrammarToken("punctuation", compileHighlightPattern("\"|'")),
]);

final Grammar _g42 = Grammar([
  GrammarToken("punctuation", compileHighlightPattern("^="),
      alias: "attr-equals"),
