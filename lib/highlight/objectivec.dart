...
/// Syntax grammar for `objectivec`.
///
/// Import this library only when you need `objectivec` highlighting; unused
/// languages are dropped from the build.
abstract final class HighlightObjectivec {
  /// The grammar for `objectivec`.
