...
/// Syntax grammar for `tsx`.
///
/// Import this library only when you need `tsx` highlighting; unused
/// languages are dropped from the build.
abstract final class HighlightTsx {
  /// The grammar for `tsx`.
...
final Grammar _g34 = Grammar([
  GrammarToken(
      "regex-source", compileHighlightPattern("^(\\/)[\\s\\S]+(?=\\/[a-z]*\$)"),
      lookbehind: true, alias: "language-regex", inside: () => _g35),
  GrammarToken("regex-delimiter", compileHighlightPattern("^\\/|\\/\$")),
  GrammarToken("regex-flags", compileHighlightPattern("^[a-z]+\$")),
]);
...
final Grammar _g40 = Grammar([
  GrammarToken(
      "regex-source", compileHighlightPattern("^(\\/)[\\s\\S]+(?=\\/[a-z]*\$)"),
      lookbehind: true, alias: "language-regex", inside: () => _g41),
  GrammarToken("regex-delimiter", compileHighlightPattern("^\\/|\\/\$")),
  GrammarToken("regex-flags", compileHighlightPattern("^[a-z]+\$")),
]);
